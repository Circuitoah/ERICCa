...
def Gammap(b ):
    ...
    Built in pp form of the profile function. Used in proton-nucleous reactions.
    
    Input parameters
        b: float, but could also be an array
        alpha_pp: (float), the NN scattering amplitude [ ]
        beta_pp : (float), the finite range parameter [fm^2]
        sigma_pp: (float), the proton-proton cross section [fm^2]

        alpha_pn: (float), the NN scattering amplitude [ ]
        beta_pn : (float), the finite range parameter [fm^2]
        sigma_pn: (float), the proton-neutron cross section [fm^2]
...
# calculating the profile function 
    ...
    Built in pn form of the profile function. Used in proton-nucleous reactions.
...
# calcualating the projectile/target density
    """
    alculates the density of a two point fermi funciton as a function of impact parameter b at point b
